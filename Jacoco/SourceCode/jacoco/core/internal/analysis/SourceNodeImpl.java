...
public class SourceNodeImpl extends CoverageNodeImpl implements ISourceNode {
	...
	//child也就是covergae，是ClassCoverageImpl实例对象，也可以是MethodCoverageImplement对象
	public void increment(final ISourceNode child) {
		//child.getInstructionCounter 返回ICounter对象
		//关于instructionCounter去本类的父类CoverageNodeImpl中寻找
		//instructionCounter实现自CounterImpl中
