 ...
 * runtime.
 */
//该策略添加了一个静态字段来保持探针阵列，添加了一个静态初始化方法请求探针阵列
//为正常的class文件添加静态字段来保持probe探针数组
//以及添加静态的初始化函数请求probe探针数组
...
//InstrSupport.INITMETHOD_NAME:初始化函数名$jacocoInit
//InstrSupport.INITMETHOD_DESC:初始化函数描述符()[Z
//Opcodes.INVOKESTATIC:调用静态方法
//完成的函数应该是：	boolean[] arrayOfBoolean = $jacocoInit();
