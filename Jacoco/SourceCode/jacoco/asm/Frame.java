...
/*  731 */     switch (desc.charAt(index)) { case 'V':
/*  733 */       return 0;
/*      */     case 'B':
/*      */     case 'C':
/*      */     case 'I':
...
/* 1064 */       int t1 = pop();
/* 1065 */       set(arg, t1);
/* 1066 */       if (arg <= 0) return;
/* 1067 */       int t2 = get(arg - 1);
/*      */ 
/* 1069 */       if ((t2 == 16777220) || (t2 == 16777219)) {
/* 1070 */         set(arg - 1, 16777216); return;
/* 1071 */       }if ((t2 & 0xF000000) == 16777216) return;
/* 1072 */       set(arg - 1, t2 | 0x800000); break;
/*      */     case 55:
/*      */     case 57:
/* 1078 */       pop(1);
/* 1079 */       int t1 = pop();
...
/* 1082 */       if (arg <= 0) return;
/* 1083 */       int t2 = get(arg - 1);
/*      */ 
/* 1085 */       if ((t2 == 16777220) || (t2 == 16777219)) {
/* 1086 */         set(arg - 1, 16777216); return;
/* 1087 */       }if ((t2 & 0xF000000) == 16777216) return;
/* 1088 */       set(arg - 1, t2 | 0x800000); break;
/*      */     case 79:
/*      */     case 81:
/*      */     case 83:
/*      */     case 84:
...
/*      */         {
/* 1530 */           v = t & 0xF0000000 | 0x1700000 | cw
/* 1530 */             .getMergedType(t & 0xFFFFF, u & 0xFFFFF);
/*      */         }
/*      */         else
/*      */         {
...
/*      */ 
/* 1547 */           v = Math.min(tdim, udim) | 0x1700000 | cw
/* 1547 */             .addType("java/lang/Object");
/*      */         }
/*      */         else
/*      */         {
/* 1550 */           v = 16777216;
 ...
 * Qualified Name:     org.jacoco.asm.Frame
