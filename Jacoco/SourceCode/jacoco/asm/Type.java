...
/* 423 */         return n << 2 | (((car == 'D') || (car == 'J')) ? 2 : (car == 'V') ? 0 : 1);
/*     */       }
/* 425 */       if (car == 'L') {
...
/* 491 */         ++len; } return new Type(10, buf, off + 1, len - 1);
/*     */     case 'E':
/*     */     case 'G':
/*     */     case 'H':
/*     */     case 'K':
...
/* 566 */       return "double";
/*     */     case 9:
/* 568 */       StringBuilder sb = new StringBuilder(getElementType().getClassName());
/* 569 */       for (int i = getDimensions(); i > 0; --i) {
/* 570 */         sb.append("[]");
/*     */       }
...
/* 785 */         buf.append(car);
/* 786 */         return;
/* 787 */       }if (!d.isArray()) break;
/* 788 */       buf.append('[');
/* 789 */       d = d.getComponentType();
/*     */     }
/* 791 */     buf.append('L');
...
/* 869 */         return false;
/*     */       }
/* 871 */       int i = this.off; int j = t.off; for (int end = i + this.len; i < end; ++j) {
...
/* 888 */     if (this.sort >= 9) {
/* 889 */       int i = this.off; for (int end = i + this.len; i < end; ++i) {
 ...
 * Qualified Name:     org.jacoco.asm.Type
