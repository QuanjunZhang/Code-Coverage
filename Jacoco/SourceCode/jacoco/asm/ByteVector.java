...
/* 285 */       char c = s.charAt(j);
/* 286 */       if ((c >= '\001') && (c <= '')) {
/* 287 */         this.data[(len++)] = (byte)c;
/* 288 */       } else if (c > '߿') {
/* 289 */         this.data[(len++)] = (byte)(0xE0 | c >> '\f' & 0xF);
/* 290 */         this.data[(len++)] = (byte)(0x80 | c >> '\006' & 0x3F);
/* 291 */         this.data[(len++)] = (byte)(0x80 | c & 0x3F);
/*     */       } else {
/* 293 */         this.data[(len++)] = (byte)(0xC0 | c >> '\006' & 0x1F);
 ...
 * Qualified Name:     org.jacoco.asm.ByteVector
